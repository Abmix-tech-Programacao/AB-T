...
- `BASE_URL=https://projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host`
- `DOMAIN=projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host`
- `SOBREIP_SERVER=voz.sobreip.com.br`
- `SOBREIP_USERNAME=1151944022`
- `SOBREIP_DID=+5511951944022`
- `WEBHOOK_MEDIA_URL=wss://projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host/media`
- `WEBHOOK_EVENTS_URL=https://projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host/events`
...
```
URL: wss://projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host/media
Protocolo: WebSocket
...
3. Configure o webhook de mídia:
   - **Media Stream URL**: `wss://projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host/media`

#### 2. Endpoint de Eventos (Status de Chamadas)
```
URL: https://projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host/events
Método: POST
Formato: JSON
...
2. Configure:
   - **Event URL**: `https://projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host/events`
   - **Método**: POST
...
- [ ] Webhook de mídia configurado: `wss://projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host/media`
- [ ] Webhook de eventos configurado: `https://projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host/events`
...
curl https://projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host/api/health
...
curl -X POST https://projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host/events \
...
- **Solução**: 
  1. Confirme que o endpoint está acessível: `curl https://projeto-abmix-tech-abmix-telefone2.asfaje.easypanel.host/events`
