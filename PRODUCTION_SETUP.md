...
### Endereços de Acesso
- **URL Principal**: https://telefone.abmix.tech
...
- `BASE_URL=https://telefone.abmix.tech`
- `DOMAIN=telefone.abmix.tech`
- `SOBREIP_SERVER=voz.sobreip.com.br`
- `SOBREIP_USERNAME=1151944022`
- `SOBREIP_DID=+5511951944022`
- `WEBHOOK_MEDIA_URL=wss://telefone.abmix.tech/media`
- `WEBHOOK_EVENTS_URL=https://telefone.abmix.tech/events`
...
```
URL: wss://telefone.abmix.tech/media
Protocolo: WebSocket
...
3. Configure o webhook de mídia:
   - **Media Stream URL**: `wss://telefone.abmix.tech/media`

#### 2. Endpoint de Eventos (Status de Chamadas)
```
URL: https://telefone.abmix.tech/events
Método: POST
Formato: JSON
...
2. Configure:
   - **Event URL**: `https://telefone.abmix.tech/events`
   - **Método**: POST
...
- [ ] Webhook de mídia configurado: `wss://telefone.abmix.tech/media`
- [ ] Webhook de eventos configurado: `https://telefone.abmix.tech/events`
...
curl https://telefone.abmix.tech/api/health
...
curl -X POST https://telefone.abmix.tech/events \
...
- **Solução**: 
  1. Confirme que o endpoint está acessível: `curl https://telefone.abmix.tech/events`
